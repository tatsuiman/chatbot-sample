...
@click.option(
    "--loader-cls", "-l", default="text", type=click.Choice(FILE_LOADER_CLASSES.keys()), help="Loader class to use"
)
@click.option(
    "--dir-loader-cls",
    "-dl",
    default="directory",
    type=click.Choice(DIR_LOADER_CLASSES.keys()),
    help="Loader class to use for directories",
)
